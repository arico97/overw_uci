...
from modellying import patient_pred
...
# family history ow
FHO = st.selectbox("Do you have a family member who has suffered or suffers from overweight?",["yes","no"])
# FAVC (high kcal freq?)
...
TUE = st.slider("How much time do you use technological devices such as cell phone, videogames, television, computer and others?", 0, 2, 0)
